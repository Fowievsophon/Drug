...
public class MyOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        strDrug[50] = "insert into drugTABLE VALUES (null, 'มะขามแขก', 'ยาใช้ภายใน', 'รับประทาน', 'ช่วยบรรเทาอาการท้องผูก', 'ใช้ฝักประมาณ 10-15 ฝัก นำมาต้มกับน้ำ 1 ถ้วยแก้วประมาณ 4 นาที และใส่เกลือเล็กน้อยเพื่อช่วยกลบรสเฝื่อน แล้วใช้รับประทานเพียงครั้งเดียว');";
        strDrug[51] = "insert into drugTABLE VALUES (null, 'หญ้าหนวดแมว', 'ยาใช้ภายใน', 'รับประทาน', 'ช่วยขับปัสสาวะและรักษานิ่วในกระเพาะปัสสาวะ', 'ใช้ต้นกับใบประมาณ 90-120 กรัม นำมาต้มกับน้ำ ดื่มก่อนอาหารครั้งละ 1 ถ้วยชา หรือประมาณ 75 cc. วันละ 3 ครั้ง');";
        strDrug[52] = "insert into drugTABLE VALUES (null, 'เพชรสังฆาต', 'ยาใช้ภายใน', 'รับประทาน', 'ขับลมในลำไส้ช่วยบรรเทาอาการริดสิดวงทวารหนัก', 'ใช้แบบแห้งนำมาบดเป็นผง ใส่แคปซูลเบอร์ 2 ขนาด 250 มิลกรัม รับประทานครั้งละ 2 แคปซูล วันละ 4 ครั้งก่อนอาหาร รับประทาน 1 อาทิตย์ก็จะเห็นผล');";
        strDrug[53] = "insert into drugTABLE VALUES (null, 'กระเทียมแคปซูล', 'ยาใช้ภายใน', 'เม็ด', 'ช่วยลดระดับคอเลสตอรอลในเลือดและละลายลิ่มเลือดได้', 'รับประทานครั้งละ 1-3 เม็ด วันละ 3 ครั้ง หลังอาหาร');";
        strDrug[54] = "insert into drugTABLE VALUES (null, 'ธรณีสัณฑะฆาต', 'ยาใช้ภายใน', 'เม็ด', 'แก้ท้องผูกปวดท้อง', 'ให้ทาน 2-4 แคปซูล ก่อนนอน 5 วัน ทานน้ำมาก ๆ ระหว่างวัน และหากวันไหนท้องผูกจึงทานอีกครั้ง');";
        strDrug[55] = "insert into drugTABLE VALUES (null, 'ขี้เหล็ก', 'ยาใช้ภายใน', 'รับประทาน', 'ช่วยแก้อาการท้องผูก เป็นยาระบาย', 'ใช้ใบอ่อน 2-3 กำมือ นำมาต้มกับน้ำครึ่งถ้วยแก้วเติมเกลือเล้กน้อย ใช้ดื่มหลังตื่นนอนหรือก่อนอาหารเช้าเพียงครั้งเดียว');";
        strDrug[56] = "insert into drugTABLE VALUES (null, 'บอระเพ็ด', 'ยาใช้ภายใน', 'รับประทาน', 'ช่วยลดน้ำตาลในเลือด แก้ไข้ ช่วยในการเจริญอาหาร', 'นำบอระเพ็ดตากแห้ง แล้วนำมาบดใส่แคปซูล ทานวันละ 2-3 แคปซูลโดยทานก่อนอาหารเช้า เย็น');";
        strDrug[57] = "insert into drugTABLE VALUES (null, 'มะระขี้นก', 'ยาใช้ภายใน', 'รับประทาน', 'ลดน้ำตลาดในเลือด ช่วยเจริญอาหาร ลดไข้', 'ใช้ผลสดของมะระขี้นกต้มรับประทาน หรือจะใช้รากสดของมะระขี้นกประมาณ 30 กรัม ต้มกับน้ำดื่ม หรือใช้เถาแห้งประมาณ 3 กรัมต้มกับน้ำดื่ม');";
        strDrug[58] = "insert into drugTABLE VALUES (null, 'สหัสธารา', 'ยาใช้ภายใน', 'รับประทาน', 'รักษาอาการปวดเมื่อยกล้ามเนื้อ ปวดข้อ อาการชา', 'รับประทาน 4-6 เม็ด ก่อนอาหาร เช้า กลางวัน เย็นห');";
        ...
        strDrug[60] = "insert into drugTABLE VALUES (null, 'ลูกยอ', 'ยาใช้ภายใน', 'รับประทาน', 'แก้อาหารวิงเวียนศรีษะหรืออาเจียน', 'ใช้ผลดิบแก่ฝานเป็นชิ้นบางๆ ย่างไฟให้เหลือง ต้มหรือชงดื่ม ใช้ครั้งละประมาณ 2 กำมือ (10-15 กรัม) เอาน้ำที่ได้จิบทีละน้อยและบ่อยๆ ครั้งจึงจะได้ผลดี');";
        strDrug[61] = "insert into drugTABLE VALUES (null, 'กระชายดำ', 'ยาใช้ภายใน', 'รับประทาน', 'ขับลม แก้ท้องอืด และบำรุงร่างกาย', 'ให้ใช้เหง้าของกระชายดำนำมาปิ้งไฟให้สุกแล้วนำมาตำให้ละเอียดใช้ผสมกับน้ำปูนใสแล้วคั้นเอาแต่น้ำมาดื่มครั้งละ 3-5 ช้อนแกงหลังจากการถ่ายเนื่องมีอาการท้องเดิน');";
        strDrug[62] = "insert into drugTABLE VALUES (null, 'ส้มแขก', 'ยาใช้ภายใน', 'รับประทาน', 'ช่วยลดคอเลสเตอรอลและลดการสร้างไขมัน', 'ใช้ในการปรุงกับอาหารที่มีรสเปรี้ยว เช่น แกงส้ม ต้มยำ');";
        strDrug[63] = "insert into drugTABLE VALUES (null, 'เทพธารา', 'ยาใช้ภายใน', 'รับประทาน', 'รักษาอาการปวดเมื่อย กล้ามเนื้อ ปวดข้อ และบำรุงกำลัง', 'รับประทานหลังอาหาร เช้า กลางวัน เย็น ครั้งละ 1 แคปซูล');";
        strDrug[64] = "insert into drugTABLE VALUES (null, 'ยาห้าราก', 'ยาใช้ภายใน', 'รับประทาน', 'ลดไข้ แก้ปวด', 'ผู้ใหญ่ ครั้งละ 3 แคปซูล รับประทานวันละ 3 ครั้ง ก่อนอาหาร เมื่อมีอาการเด็ก อายุ 6-12 ปี ครั้งละ 2 แคปซูล รับประทานวันละ 3 ครั้ง ก่อนอาหาร เมื่อมีอาการ');";
        ...
        strDrug[66] = "insert into drugTABLE VALUES (null, 'ยาแก้ไอมะขามป้อม', 'ยาใช้ภายใน', 'รับประทาน', 'ช่วยบรรเทาอาการไอ เจ็บคอ', 'จิบเมื่อมีอาการ ได้ทุกเวลา');";
        strDrug[67] = "insert into drugTABLE VALUES (null, 'ดอกคำฟอย', 'ยาใช้ภายใน', 'รับประทาน', 'ลดไขมันในเลือด และลดความดันโลหิต', 'ใช้ดอกแห้ง 2 หยิบมือ (2.5 กรัม) ชงน้ำร้อนครึ่งแก้ว ดื่มเป็นเครื่องดื่มได้');";
        strDrug[68] = "insert into drugTABLE VALUES (null, 'ยาผงหญ้าดอกข้าว', 'ยาใช้ภายใน', 'รับประทาน', 'ช่วยลดการสูบบุหรี่  แก้ไข้', 'ชงกับน้ำร้อน ทิ้งไว้ 5-10 นาที่ รอให้ชา ออกสี กลิ่น แล้วค่อยรัปประทาน 1 ซองชงได้ 2-3 น้ำ จิบบ่อยๆ ช่วยให้ไม่อยากบุหรี่ ไม่อยากข้าว');";
        strDrug[69] = "insert into drugTABLE VALUES (null, 'ยาผงชะพลู', 'ยาใช้ภายใน', 'รับประทาน', 'ช่วยลดน้ำตาลในเลือด แก้ไอ ละลายเสมหะ', 'ใส่ยา 1 ถุงสำหรับชงลงในแก้ว เติมน้ำเดือดตั้งทิ้งไว้ 2-3 นาที ดื่มขณะอุ่น ๆ ครั้งละ 1 แก้ว 3 เวลา หลังอาหาร');";
        strDrug[70] = "insert into drugTABLE VALUES (null, 'เถาวัลย์เปรียง', 'ยาใช้ภายใน', 'รับประทาน', 'ช่วยบรรเทาอาหารปวดกล้ามเนื้อ', 'นำผงจากเถาของเถาวัลย์เปรียง ผสมน้ำรับประทานครั้งละ 500 มิลลิกรัม ถึง 1 กรัม วันละ 3 ครั้ง หลังอาหารทันที');";
